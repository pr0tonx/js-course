...
// Page navigation (smooth scrolling while clicking links from the top of the page
...
// not recommended due to bad performance using scroll event
...
// Don't use because will overwrite everything that is already there
...
document.querySelector('.nav__link').addEventListener('click', function (event) {
  ...
  // Stop propagation
  // event.stopPropagation(); // not recommended
});
...
=> Scripts not guaranteed to executed in order
