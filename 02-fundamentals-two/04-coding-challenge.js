...
average of all numbers in the given array. This is a difficult challenge (we haven't done this before)! Here is how to
solve it:
...
console.log(tips);
console.log(totals);
console.log(`The average of all bills is ${calcAverage(bills)}`);
console.log(`The average of all tips is ${calcAverage(tips)}`);
console.log(`The average of all totals (bills plus tips) is ${calcAverage(totals)}`);
